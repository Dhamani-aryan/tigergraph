...
| FraudCase vectors from earlier runs retrieved as evidence | Assessment retrieval searches KnowledgeDoc + ClosedCase only (FraudCase still written); balanced 3 confirmed-fraud + 3 cleared; query built from the measured case shape | `vector_search.py` |
